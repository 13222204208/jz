    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">添加户型</div>
          <div class="layui-card-body" >
            ...
            <div class="layui-form" lay-filter="">
              ...
              <div class="layui-form-item">
                <label class="layui-form-label" style="width:130px">户型名称</label>
                <div class="layui-input-inline">
                  <input type="text" name="name" placeholder="例如 一室一厅一卫" value=""   class="layui-input">
                </div>
              </div>
      ...
      <div class="layui-row" id="popUpdateTest" style="display:none;">
        <form class="layui-form layui-from-pane" required lay-verify="required" lay-filter="formUpdate"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" required lay-verify="type_name" autocomplete="off"
                        placeholder="请输入标签名称" value="" class="layui-input">
                </div>
            </div>
