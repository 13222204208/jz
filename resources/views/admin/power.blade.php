            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                   {{--  <input type="text" name="name" required lay-verify="name" autocomplete="off"
                        ...
                        <textarea placeholder="可以添加多条数据，用逗号 , 分隔"  name="route" class="layui-textarea"></textarea>
                </div>
            </div>
        ...
        <form class="layui-form layui-from-pane" required lay-verify="required" lay-filter="formUpdate"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="text" name="route" required lay-verify="name" autocomplete="off"
                        placeholder="请输入路由名称" value="" class="layui-input">
                </div>
            </div>
            ...
            table.on('tool(user)', function (obj) {
                ...
                if (obj.event === 'del') {
                  ...
                  tableIns= table.render({
                      url: "gain/admin/permission"+'/'+id //数据接口
                          ,
                      page: true //开启分页
                          ,
                      elem: '#LAY_table_user',
